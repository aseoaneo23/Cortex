...
public class AiService {
    ...
    public Map<String, Object> processItem(String content, String type) {
        String prompt = "You are a highly efficient knowledge extraction engine.\n" +
                "Analyze the input and return a JSON object.\n\n" +
                "CLUES FOR CLASSIFICATION:\n" +
                "- If it sounds like a command or has a date/deadline, category is \"task\".\n" +
                "- If it is a URL starting with youtube.com or youtu.be, add \"youtube\" and \"video\" tags.\n" +
                "- If it is technical/code, category is \"tech\".\n\n" +
                "REQUIRED JSON STRUCTURE:\n" +
                "{\n" +
                "  \"title\": \"Concise specific title\",\n" +
                "  \"summary\": \"1-2 sentence overview\",\n" +
                "  \"category\": \"study|tech|idea|task|reference\",\n" +
                "  \"tags\": [\"tag1\", \"tag2\"],\n" +
                "  \"content\": \"A well-formatted markdown note. IF THE INPUT IS A URL, START THE CONTENT WITH: Source: [URL](URL)\",\n" +
